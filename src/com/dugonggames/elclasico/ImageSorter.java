...
public class ImageSorter {
    public static void sort(DigitImage[] images, int pixel){
        sort(images, pixel, 0, images.length-1);
    }

    private static void merge(DigitImage[] images, int pixel, int l, int m, int r) {
        int n1 = m - l + 1;
        int n2 = r - m;
    ...
    private static void sort(DigitImage[] images, int pixel, int l, int r) {
        if (l < r) {
            int m = (l+r)/2;
            sort(images, pixel, l, m);
            sort(images, pixel, m+1, r);
            merge(images, pixel, l, m, r);
        }
    }
