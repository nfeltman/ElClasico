...
object DigitsMain {
    ...
    fun main(args: Array<String>) {
        ...
        for (i in 0..59999) trainingimages[i] = DigitImage.fromFile(trainingimagesbytes, 16 + 784 * i, traininglabelsbytes, 8 + i)

        val t = Tree(trainingimages)

        val testimages = arrayOfNulls<DigitImage>(60000)
        for (i in 0..9999) testimages[i] = DigitImage.fromFile(testimagesbytes, 16 + 784 * i, testlabelsbytes, 8 + i)
